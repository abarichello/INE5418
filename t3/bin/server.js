...
Server.main = function() {
	...
	console.log("Server.hx:25:","Server is listening at port 8080");
};
var Root = function() {
};
Root.__name__ = true;
Root.prototype = {
	...
	,sum: function(body) {
		...
		var res = Lambda.fold(body.operands,sum,0);
		this.print("Received /calculate/sum with operands " + Std.string(body.operands) + " which results in " + res);
		return { "result" : res};
	}
	,subtraction: function(body) {
		var start = body.operands[0];
		HxOverrides.remove(body.operands,0);
		var sum = function(num,total) {
			total -= num;
			return total;
		};
		var res = Lambda.fold(body.operands,sum,start);
		this.print("Received /calculate/subtraction with operands " + Std.string(body.operands) + " which results in " + res);
		return { "result" : res};
	}
	,multiplication: function(body) {
		...
		var res = Lambda.fold(body.operands,sum,start);
		this.print("Received /calculate/multiplication with operands " + Std.string(body.operands) + " which results in " + res);
		return { "result" : res};
	}
	,division: function(body) {
		if(body.operands.length != 2) {
			var this1 = new tink_http_ResponseHeaderBase(400,null,null,"HTTP/1.1");
			var this2 = new tink_http__$Response_OutgoingResponseData(this1,new tink_streams_Single(new tink_core__$Lazy_LazyConst(tink_chunk_ByteChunk.of(haxe_io_Bytes.ofString(JSON.stringify({ "error" : "Invalid number of operands"}))))));
			var error = this2;
			return error;
		}
		if(body.operands[1] == 0) {
			var this1 = new tink_http_ResponseHeaderBase(400,null,null,"HTTP/1.1");
			var this2 = new tink_http__$Response_OutgoingResponseData(this1,new tink_streams_Single(new tink_core__$Lazy_LazyConst(tink_chunk_ByteChunk.of(haxe_io_Bytes.ofString(JSON.stringify({ "error" : "Invalid division by zero"}))))));
			var error = this2;
			return error;
		}
		var this1 = new tink_http_ResponseHeaderBase(400,null,null,"HTTP/1.1");
...
tink_json_JsonString._new = function(raw,min,max) {
	var this1 = raw.substring(min,max);
	return this1;
};
...
tink_json_BasicParser.prototype = {
	...
	,slice: function(from,to) {
		var this1 = this.source.substring(from,to);
		return this1;
	}
	,next: function() {
...
tink_json_Parser0.prototype = $extend(tink_json_BasicParser.prototype,{
	process0: function() {
										...
										if(cur == 100) {
											...
											if(cur == 115) {
												...
												if(cur == 34) {
													...
													if(!v__02) {
														while(true) {
															__ret.push(parseInt(this.parseNumber()));
															while(this.source.charCodeAt(this.pos) < 33) this.pos++;
															var v__03;
															if(this.source.charCodeAt(this.pos) == 44) {
																this.pos += 1;
		...
		return { _0 : hasv__0 ? v__0 : __missing__("operands")};
	}
...
tink_json_Parser1.prototype = $extend(tink_json_BasicParser.prototype,{
	process0: function() {
		...
		return { _1 : hasv__1 ? v__1 : __missing__("operands")};
	}
	,parse: function(source) {
		var _gthis = this;
		if(_gthis.afterParsing.length > 0) {
...
tink_json_Parser2.prototype = $extend(tink_json_BasicParser.prototype,{
	process0: function() {
		...
		return { _2 : hasv__2 ? v__2 : __missing__("operands")};
	}
	,parse: function(source) {
		var _gthis = this;
		if(_gthis.afterParsing.length > 0) {
...
tink_json_Parser3.prototype = $extend(tink_json_BasicParser.prototype,{
	process0: function() {
		...
		return { _3 : hasv__3 ? v__3 : __missing__("operands")};
	}
	,parse: function(source) {
		var _gthis = this;
		if(_gthis.afterParsing.length > 0) {
...
tink_querystring_Parser0.prototype = $extend(tink_querystring_ParserBase.prototype,{
	...
	,process0: function(prefix) {
		...
		var ret = [];
		while(true) {
			var prefix = prefix1 + "[" + counter + "]";
			if(this.exists.h[prefix]) {
				ret.push(this.exists.h[prefix] ? tink_web_forms_FormField.toInt(this.params.h[prefix]) : this.missing(prefix));
				++counter;
			} else {
				break;
			}
...
var tink_querystring_Parser3 = function(onError,pos) {
	tink_querystring_ParserBase.call(this,onError,pos);
};
tink_querystring_Parser3.__name__ = true;
tink_querystring_Parser3.__super__ = tink_querystring_ParserBase;
tink_querystring_Parser3.prototype = $extend(tink_querystring_ParserBase.prototype,{
	getName: function(p) {
		return p.name;
	}
	,getValue: function(p) {
	...
	,__class__: tink_querystring_Parser3
});
...
tink_web_routing_Router0.prototype = {
			...
			if(_g1 == "hello") {
				if(_g3 == true) {
					if(_g4 == false) {
						...
						return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(404,"Not Found: [" + ctx.request.header.method + "] " + (this1.query == null ? this1.path : (this1.path == null ? "null" : this1.path) + "?" + (this1.query == null ? "null" : this1.query)),{ fileName : "Server.hx", lineNumber : 19, className : "tink.web.routing.Router0", methodName : "route"}))));
					}
				} else {
					var this1 = ctx.request.header.url;
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(404,"Not Found: [" + ctx.request.header.method + "] " + (this1.query == null ? this1.path : (this1.path == null ? "null" : this1.path) + "?" + (this1.query == null ? "null" : this1.query)),{ fileName : "Server.hx", lineNumber : 19, className : "tink.web.routing.Router0", methodName : "route"}))));
	...
	,hello: function(ctx) {
		return tink_core_Promise.next(new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(this.target.hello()))),function(v) {
	...
	,sum: function(ctx) {
		...
		case "application/x-www-form-urlencoded":
			tmp = tink_core_Promise.next(ctx.parse(),function(pairs) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(new tink_querystring_Parser0(null,{ fileName : "Server.hx", lineNumber : 45, className : "tink.web.routing.Router0", methodName : "sum"}).tryParse(tink_querystring_Pairs.ofIterable(pairs))));
			});
			break;
		default:
			var invalid = _g;
			tmp = new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(406,"Cannot process Content-Type " + invalid,{ fileName : "tink/web/macros/Routing.hx", lineNumber : 674, className : "tink.web.routing.Router0", methodName : "sum"}))));
		}
		return tink_core_Promise.next(tmp,function(__body__) {
			var body = { operands : __body__._0};
			return tink_core_Promise.next(new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(_gthis.target.sum(body)))),function(__data__) {
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(415,"Unsupported Media Type",{ fileName : "Server.hx", lineNumber : 45, className : "tink.web.routing.Router0", methodName : "sum"}))));
			});
		});
	}
	,subtraction: function(ctx) {
		var _gthis = this;
		var _g;
		var _g1 = ctx.request.header.contentType();
		if(_g1._hx_index == 0) {
		...
		case "application/x-www-form-urlencoded":
			tmp = tink_core_Promise.next(ctx.parse(),function(pairs) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(new tink_querystring_Parser1(null,{ fileName : "Server.hx", lineNumber : 53, className : "tink.web.routing.Router0", methodName : "subtraction"}).tryParse(tink_querystring_Pairs.ofIterable(pairs))));
			});
			break;
		default:
			var invalid = _g;
			tmp = new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(406,"Cannot process Content-Type " + invalid,{ fileName : "tink/web/macros/Routing.hx", lineNumber : 674, className : "tink.web.routing.Router0", methodName : "subtraction"}))));
		}
		return tink_core_Promise.next(tmp,function(__body__) {
			var body = { operands : __body__._1};
			return tink_core_Promise.next(new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(_gthis.target.subtraction(body)))),function(__data__) {
				if(ctx.accepts("application/json")) {
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(tink_web_routing_Response.textual(200,"application/json",new tink_json_Writer0().write(__data__),[]))));
				}
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(415,"Unsupported Media Type",{ fileName : "Server.hx", lineNumber : 53, className : "tink.web.routing.Router0", methodName : "subtraction"}))));
			});
		});
	}
	,multiplication: function(ctx) {
		var _gthis = this;
		var _g;
		var _g1 = ctx.request.header.contentType();
		if(_g1._hx_index == 0) {
		...
		case "application/json":
			tmp = tink_core_Promise.next(ctx.allRaw(),function(b) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(new tink_json_Parser2().tryParse(b.toString())));
			});
			break;
		case "application/x-www-form-urlencoded":
			tmp = tink_core_Promise.next(ctx.parse(),function(pairs) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(new tink_querystring_Parser2(null,{ fileName : "Server.hx", lineNumber : 63, className : "tink.web.routing.Router0", methodName : "multiplication"}).tryParse(tink_querystring_Pairs.ofIterable(pairs))));
			});
			break;
		default:
			var invalid = _g;
			tmp = new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(406,"Cannot process Content-Type " + invalid,{ fileName : "tink/web/macros/Routing.hx", lineNumber : 674, className : "tink.web.routing.Router0", methodName : "multiplication"}))));
		}
		return tink_core_Promise.next(tmp,function(__body__) {
			var body = { operands : __body__._2};
			return tink_core_Promise.next(new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(_gthis.target.multiplication(body)))),function(__data__) {
				if(ctx.accepts("application/json")) {
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(tink_web_routing_Response.textual(200,"application/json",new tink_json_Writer0().write(__data__),[]))));
				}
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(415,"Unsupported Media Type",{ fileName : "Server.hx", lineNumber : 63, className : "tink.web.routing.Router0", methodName : "multiplication"}))));
			});
		});
	}
	,division: function(ctx) {
		...
		case "application/json":
			tmp = tink_core_Promise.next(ctx.allRaw(),function(b) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(new tink_json_Parser3().tryParse(b.toString())));
			});
			break;
		case "application/x-www-form-urlencoded":
			tmp = tink_core_Promise.next(ctx.parse(),function(pairs) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(new tink_querystring_Parser3(null,{ fileName : "Server.hx", lineNumber : 73, className : "tink.web.routing.Router0", methodName : "division"}).tryParse(tink_querystring_Pairs.ofIterable(pairs))));
			});
			break;
		default:
			var invalid = _g;
			tmp = new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(406,"Cannot process Content-Type " + invalid,{ fileName : "tink/web/macros/Routing.hx", lineNumber : 674, className : "tink.web.routing.Router0", methodName : "division"}))));
		}
		return tink_core_Promise.next(tmp,function(__body__) {
			var body = { operands : __body__._3};
			return tink_core_Promise.next(new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(_gthis.target.division(body)))),function(v) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(v)));
			});
		});
	}
