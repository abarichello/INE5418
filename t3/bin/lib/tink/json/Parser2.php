...
class Parser2 extends BasicParser {
	...
	public function process0 () {
		...
		return new _HxAnon_Parser20(($hasv__2 ? $v__2 : $__missing__("operands")));
	}
	...
	public function tryParse ($source) {
		...
		return TypedError::catchExceptions(function () use (&$source, &$_gthis) {
			...
			return $ret;
		}, null, new _HxAnon_Parser21("tink/json/macros/Macro.hx", 107, "tink.json.Parser2", "tryParse"));
	}
}

class _HxAnon_Parser20 extends HxAnon {
	function __construct($_2) {
		$this->_2 = $_2;
	}
}

class _HxAnon_Parser21 extends HxAnon {
