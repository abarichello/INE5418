...
class Parser3 extends BasicParser {
	...
	public function process0 () {
		...
		return new _HxAnon_Parser30(($hasv__3 ? $v__3 : $__missing__("operands")));
	}
	...
	public function tryParse ($source) {
		...
		return TypedError::catchExceptions(function () use (&$source, &$_gthis) {
			...
			return $ret;
		}, null, new _HxAnon_Parser31("tink/json/macros/Macro.hx", 107, "tink.json.Parser3", "tryParse"));
	}
}

class _HxAnon_Parser30 extends HxAnon {
	function __construct($_3) {
		$this->_3 = $_3;
	}
}

class _HxAnon_Parser31 extends HxAnon {
