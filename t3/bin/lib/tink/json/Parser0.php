...
class Parser0 extends BasicParser {
	...
	public function process0 () {
		...
		return new _HxAnon_Parser00(($hasv__0 ? $v__0 : $__missing__("operands")));
	}
	...
	public function tryParse ($source) {
		...
		return TypedError::catchExceptions(function () use (&$source, &$_gthis) {
			...
			return $ret;
		}, null, new _HxAnon_Parser01("tink/json/macros/Macro.hx", 107, "tink.json.Parser0", "tryParse"));
	}
}
...
class _HxAnon_Parser01 extends HxAnon {
