...
class HxDynamicStr extends HxClosure {
	...
	public static function invoke ($str, $method, $args) {
		#/usr/share/haxe/std/php/Boot.hx:892: characters 3-34
		\array_unshift($args, $str);
		#/usr/share/haxe/std/php/Boot.hx:893: characters 3-69
	...
	public static function wrap ($value) {
		#/usr/share/haxe/std/php/Boot.hx:884: lines 884-888
		if (\is_string($value)) {
			#/usr/share/haxe/std/php/Boot.hx:885: characters 4-34
			return new HxDynamicStr($value);
		} else {
			#/usr/share/haxe/std/php/Boot.hx:887: characters 4-16
			return $value;
		}
	}
	...
	public function __construct ($str) {
		#/usr/share/haxe/std/php/Boot.hx:897: characters 3-19
	...
	public function __call ($method, $args) {
		#/usr/share/haxe/std/php/Boot.hx:913: characters 10-38
	...
	public function __get ($field) {
		#/usr/share/haxe/std/php/Boot.hx:902: lines 902-908
		if ($field === "length") {
			#/usr/share/haxe/std/php/Boot.hx:904: characters 5-36
			return mb_strlen($this->target);
		} else {
			#/usr/share/haxe/std/php/Boot.hx:906: characters 5-17
			$this->func = $field;
			#/usr/share/haxe/std/php/Boot.hx:907: characters 5-16
			return $this;
		}
	}
	...
	public function __invoke () {
		#/usr/share/haxe/std/php/Boot.hx:921: characters 10-54
		$str = $this->target;
		$method = $this->func;
		$args = \func_get_args();
		\array_unshift($args, $str);
	...
	public function callWith ($newThis, $args) {
		#/usr/share/haxe/std/php/Boot.hx:938: lines 938-940
		if ($newThis === null) {
			#/usr/share/haxe/std/php/Boot.hx:939: characters 4-20
			$newThis = $this->target;
		}
		#/usr/share/haxe/std/php/Boot.hx:941: characters 10-37
		$method = $this->func;
	...
	public function getCallback ($eThis = null) {
		#/usr/share/haxe/std/php/Boot.hx:928: lines 928-930
		if ($eThis === null) {
			#/usr/share/haxe/std/php/Boot.hx:929: characters 4-51
			return [$this, $this->func];
		}
		#/usr/share/haxe/std/php/Boot.hx:931: characters 3-69
