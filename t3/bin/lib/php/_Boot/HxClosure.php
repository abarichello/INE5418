...
class HxClosure {
	...
	public function __construct ($target, $func) {
		#/usr/share/haxe/std/php/Boot.hx:978: characters 3-23
		$this->target = $target;
		#/usr/share/haxe/std/php/Boot.hx:979: characters 3-19
		$this->func = $func;
		#/usr/share/haxe/std/php/Boot.hx:981: lines 981-983
		if (\is_null($target)) {
			#/usr/share/haxe/std/php/Boot.hx:982: characters 4-9
			throw Exception::thrown("Unable to create closure on `null`");
		}
		#/usr/share/haxe/std/php/Boot.hx:984: characters 3-104
	...
	public function __invoke () {
		#/usr/share/haxe/std/php/Boot.hx:992: characters 3-71
	...
	public function callWith ($newThis, $args) {
		#/usr/share/haxe/std/php/Boot.hx:1019: characters 3-65
	...
	public function equals ($closure) {
		#/usr/share/haxe/std/php/Boot.hx:1012: characters 10-60
		if (Boot::equal($this->target, $closure->target)) {
			#/usr/share/haxe/std/php/Boot.hx:1012: characters 39-59
	...
	public function getCallback ($eThis = null) {
		#/usr/share/haxe/std/php/Boot.hx:999: lines 999-1001
		if ($eThis === null) {
			#/usr/share/haxe/std/php/Boot.hx:1000: characters 4-18
			$eThis = $this->target;
		}
		#/usr/share/haxe/std/php/Boot.hx:1002: lines 1002-1004
		if (($eThis instanceof HxAnon)) {
			#/usr/share/haxe/std/php/Boot.hx:1003: characters 4-36
			return $eThis->{$this->func};
		}
		#/usr/share/haxe/std/php/Boot.hx:1005: characters 3-39
		return [$eThis, $this->func];
	}
}
