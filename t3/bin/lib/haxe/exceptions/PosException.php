...
class PosException extends Exception {
	...
	public function __construct ($message, $previous = null, $pos = null) {
		#/usr/share/haxe/std/haxe/exceptions/PosException.hx:13: characters 3-27
		parent::__construct($message, $previous);
		#/usr/share/haxe/std/haxe/exceptions/PosException.hx:14: lines 14-18
		if ($pos === null) {
			#/usr/share/haxe/std/haxe/exceptions/PosException.hx:15: characters 4-100
			$this->posInfos = new _HxAnon_PosException0("(unknown)", 0, "(unknown)", "(unknown)");
		} else {
			#/usr/share/haxe/std/haxe/exceptions/PosException.hx:17: characters 4-18
			$this->posInfos = $pos;
		}
	}
	...
	public function toString () {
		#/usr/share/haxe/std/haxe/exceptions/PosException.hx:25: characters 3-126
