...
class JsonPrinter {
	...
	public function fieldsString ($v, $fields) {
		...
		$first = true;
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:170: characters 13-17
		$_g = 0;
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:170: characters 17-20
		$_g1 = $len;
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:170: lines 170-192
		while ($_g < $_g1) {
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:170: characters 13-20
			$i = $_g++;
	...
	public function quote ($s) {
		...
		$i = 0;
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:205: characters 3-25
		$length = mb_strlen($s);
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:209: lines 209-251
		while ($i < $length) {
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:210: characters 4-45
			$c = \StringTools::unsafeCodeAt($s, $i++);
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:211: lines 211-250
			if ($c === 8) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:223: characters 6-16
				$this->buf->add("\\b");
			} else if ($c === 9) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:221: characters 6-16
				$this->buf->add("\\t");
			} else if ($c === 10) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:217: characters 6-16
				$this->buf->add("\\n");
			} else if ($c === 12) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:225: characters 6-16
				$this->buf->add("\\f");
			} else if ($c === 13) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:219: characters 6-16
				$this->buf->add("\\r");
			} else if ($c === 34) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:213: characters 6-16
				$this->buf->add("\\\"");
			} else if ($c === 92) {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:215: characters 6-17
				$this->buf->add("\\\\");
			} else {
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:248: characters 6-16
				$_this = $this->buf;
				$_this->b = ($_this->b??'null') . (\mb_chr($c)??'null');
			}
		}
		#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:256: characters 3-20
		$_this = $this->buf;
		$_this->b = ($_this->b??'null') . (\mb_chr(34)??'null');
	}
	...
	public function write ($k, $v) {
		...
		if ($this->replacer !== null) {
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:83: characters 4-5
			$v = ($this->replacer)($k, $v);
		}
		...
		if ($__hx__switch === 0) {
			...
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:90: characters 5-52
			$this->buf->add($v);
			...
			#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:134: characters 5-68
			...
			if ($c === Boot::getClass('String')) {
				...
				$last = $len - 1;
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:104: characters 16-20
				$_g1 = 0;
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:104: characters 20-23
				$_g2 = $len;
				#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:104: lines 104-117
				while ($_g1 < $_g2) {
					#/usr/share/haxe/std/haxe/format/JsonPrinter.hx:104: characters 16-23
					$i = $_g1++;
